...
class PosRepository {
  ...
  Future<Map<String, dynamic>> getRuntimeConfig() async {
    const fallbackPermissions = <String, dynamic>{
      ...
      'view_inventory_scraps': false,
      'create_inventory_purchases': false,
      'update_inventory_purchases': false,
      'submit_inventory_purchases': false,
      'approve_inventory_purchases': false,
      'reject_inventory_purchases': false,
      'receive_inventory_purchases': false,
      'delete_inventory_purchases': false,
      'create_inventory_opnames': false,
      'update_inventory_opnames': false,
      'submit_inventory_opnames': false,
      'approve_inventory_opnames': false,
      'post_inventory_opnames': false,
      'reject_inventory_opnames': false,
      'cancel_inventory_opnames': false,
      'delete_inventory_opnames': false,
      'create_inventory_transfers': false,
      'update_inventory_transfers': false,
      'submit_inventory_transfers': false,
      'approve_inventory_transfers': false,
      'reject_inventory_transfers': false,
      'post_inventory_transfers': false,
      'cancel_inventory_transfers': false,
      'delete_inventory_transfers': false,
      'create_inventory_scraps': false,
      'update_inventory_scraps': false,
      'approve_inventory_scraps': false,
      'reject_inventory_scraps': false,
      'process_inventory_scraps': false,
      'delete_inventory_scraps': false,
    };
